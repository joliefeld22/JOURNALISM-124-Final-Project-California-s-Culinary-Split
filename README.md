...
The data makes clear that the James Beard Foundation has historically favored San Francisco over Los Angeles, both in volume and in the rate at which it converts recognition into wins. But it cannot explain why.
One possible interpretation: SF's food scene has long been associated with the fine dining traditions that the James Beard Foundation was founded to celebrate. LA's culinary identity is more decentralized, more immigrant-driven, and more likely to express itself through formats that have historically been underrepresented in fine dining award culture.
...
The data is a starting point, not a conclusion. But it points clearly toward a story worth telling.
